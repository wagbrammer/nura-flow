...
export const hasValidSession = async (cookieHeader: string | null | undefined, config: AuthConfig) => {
  try {
...
<html lang="pt-BR">
  ...
  <body>
    <main class="shell">
      <div class="brand">${logoUrl ? `<img src="${logoUrl}" alt="Logo" class="mark-logo" style="width: 44px; height: 44px; border-radius: 15px; object-fit: contain; background: white; padding: 4px;" />` : `<div class="mark">N</div>`}<div><strong>NURA</strong><span>Produtividade e conhecimento</span></div></div>
