 ...
 *
 * Não há mudanças de lógica – apenas pequenas correções de tipagem
 * e adição de import explícito de `crypto` (opcional, mas limpa o
 * lint do TypeScript).
 */

import { webcrypto as crypto } from "crypto"; // garante tipagem TS (global em Node 20)
